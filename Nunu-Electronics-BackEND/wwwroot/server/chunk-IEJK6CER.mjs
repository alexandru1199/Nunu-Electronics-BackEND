...
AdminAddProductComponent = __decorate([
  Component({
    ...
    standalone: true,
    imports: [ReactiveFormsModule, CommonModule],
    // Adăugăm ReactiveFormsModule aici
...
//# sourceMappingURL=chunk-IEJK6CER.mjs.map
