...
var AdminAddProductComponent = class AdminAddProductComponent2 {
  ...
  ngOnInit() {
    if (typeof window !== "undefined") {
      alert("ngOnInit a fost apelat!");
      const fileInput = document.querySelector('input[type="file"]');
      if (fileInput) {
        fileInput.addEventListener("change", this.onFileSelected.bind(this));
      } else {
        console.warn("\u26A0\uFE0F Input-ul de fi\u0219ier nu a fost g\u0103sit \xEEn DOM.");
      }
    } else {
      console.warn("\u26A0\uFE0F Codul ruleaz\u0103 \xEEn afara browserului (SSR probabil).");
    }
  }
...
//# sourceMappingURL=chunk-2IHWPH5U.mjs.map
