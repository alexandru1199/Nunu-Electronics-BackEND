...
var AdminAddProductComponent = class AdminAddProductComponent2 {
  ...
  ngOnInit() {
    alert("ngOnInit a fost apelat \u2014 suntem \xEEn iadul debuggingului \u{1F525}");
    console.log("iadul?");
    if (typeof window !== "undefined") {
      ...
      if (fileInput) {
        ...
        console.warn("Input-ul de tip file nu a fost g\u0103sit.");
      }
    } else {
      console.warn("Nu suntem \xEEn context de browser.");
    }
  }
  // Metodă pentru a selecta un fișier de imagine
  onFileSelected(event) {
    const input = event.target;
    if (input?.files?.[0]) {
      const file = input.files[0];
      ...
      reader.onload = () => {
        ...
        console.log("Imagine Base64:", this.imageBase64);
        localStorage.setItem("product-image", this.imageBase64 || "");
        console.log("Salvat \xEEn localStorage!");
      };
      reader.readAsDataURL(file);
    }
  }
  // Metodă pentru a trimite formularul
  onSubmit() {
...
//# sourceMappingURL=chunk-X2NW4PDV.mjs.map
