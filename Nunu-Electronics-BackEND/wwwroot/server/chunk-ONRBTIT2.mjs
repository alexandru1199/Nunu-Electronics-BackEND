...
var homepage_component_default = `<!DOCTYPE html>\r
<html lang="en">\r
<head>\r
  <meta charset="UTF-8">\r
  <meta name="viewport" content="width=device-width, initial-scale=1.0">\r
  <title>Nunu Electronics</title>\r
  <!-- Link to Google Fonts for Outfit -->\r
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;700&display=swap" rel="stylesheet">\r
  <!-- Add your other meta tags and links here -->\r
</head>\r
<body>\r
  <section class="hero">\r
    <img src="https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nunu_0.jpg" alt="Nunu Electronics Banner">\r
    <h2>Nunu<span class="light-text">Electronics</span></h2>\r
    <a class='btn' routerLink="/products">Browse</a>\r
  </section>\r
\r
  <section class="products-section" id="products">\r
    <h3>Our Products</h3>\r
    <div class="products">\r
      <div class="product" *ngFor="let product of Products">\r
        <img [src]="product.image" [alt]="product.productName">\r
        <h4>{{ product.productName }}</h4>\r
        <p>{{ product.description }}</p>\r
        <a (click)="addToCart(product)" href="#" class="btn">Buy Now</a>\r
      </div>\r
    </div>\r
  </section>\r
\r
  <footer>\r
    <p>&copy; 2024 Nunu Electronics. All rights reserved.</p>\r
    <p><a href="mailto:support@nunu.com">Contact Us</a> | Phone: +1 800 555 6789</p>\r
  </footer>\r
</body>\r
</html>\r
`;
...
var ContactPageComponent = class ContactPageComponent2 {
  ...
  onSubmit() {
    const { fname, email, problem, country, subject } = this.formData;
    const to = email;
    const emailSubject = "Mesaj Important - Ac\u021Biune necesar\u0103";
    const textContent = `Salut ${fname}, ne-ai contactat despre ${problem}. Vom reveni cur\xE2nd.`;
...
var produse_component_default = `<!-- Be sure to include this in your index.html or main layout -->\r
<link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600&display=swap" rel="stylesheet" />\r
\r
<div class="product-container" style="font-family: 'Outfit', sans-serif;">\r
  <div *ngFor="let product of Products" class="product-card">\r
    ...
    <div class="product-details">\r
      ...
      <button class="add-to-cart-btn" (click)="addToCart(product)">Add to Cart!</button>\r
    </div>\r
  </div>\r
</div>\r
`;
...
//# sourceMappingURL=chunk-ONRBTIT2.mjs.map
