...
var profile_component_default = `<div class="profile-container">\r
  ...
  \r
      ...
      <button class="add-product-btn" [routerLink]="['/addproduct']">Add New Product</button>\r
      <!-- Buton de logout -->\r
...
var AdminAddProductComponent = class AdminAddProductComponent2 {
  ...
  ngOnInit() {
    console.log("\u2705 ngOnInit \u2013 suntem \xEEn browser.");
    if (this.isBrowser) {
      console.log("\u2705 ngOnInit \u2013 suntem \xEEn browser.");
    } else {
      console.warn("\u26A0\uFE0F ngOnInit \u2013 codul ruleaz\u0103 pe server (SSR activat).");
    }
  }
  ngAfterViewInit() {
    if (this.isBrowser) {
      ...
      if (fileInput) {
        ...
        console.warn('\u26A0\uFE0F input[type="file"] nu a fost g\u0103sit \xEEn DOM.');
      }
    }
  }
  onFileSelected(event) {
...
//# sourceMappingURL=chunk-4OSD54HL.mjs.map
