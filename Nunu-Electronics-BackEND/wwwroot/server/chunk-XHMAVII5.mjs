...
function CartComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_div_5_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
...
var CartComponent = class _CartComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 3, consts: [[1, "cart-container"], ["class", "empty-cart-message", 4, "ngIf"], ["class", "cart-item", 4, "ngFor", "ngForOf"], ["class", "cart-summary", 4, "ngIf"], [1, "empty-cart-message"], [1, "cart-item"], [1, "cart-item-image", 3, "src", "alt"], [1, "cart-item-details"], [1, "price"], [1, "quantity-container"], [3, "click", "disabled"], [1, "quantity"], [3, "click"], [1, "remove-btn", 3, "click"], [1, "cart-summary"], [1, "clear-cart-btn", 3, "click"]], template: function CartComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "h2");
        \u0275\u0275text(2, "Your Shopping Cart");
        \u0275\u0275elementEnd();
        \u0275\u0275template(3, CartComponent_div_3_Template, 3, 0, "div", 1)(4, CartComponent_div_4_Template, 16, 6, "div", 2)(5, CartComponent_div_5_Template, 5, 1, "div", 3);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-XHMAVII5.mjs.map
