  ...
  onFileSelected(event) {
    ...
    if (input.files && input.files[0]) {
      ...
      reader.onload = () => {
        ...
        console.log("Loaded image to localStorage");
      };
      reader.readAsDataURL(file);
    }
  }
  onSubmit() {
    if (this.productForm.valid && this.imageBase64) {
      const product = {
        ...
        tagId: this.productForm.value.tagId,
      ...
      alert("Complete all fields and upload an image.");
    }
  }
  static {
    this.ctorParameters = () => [
...
//# sourceMappingURL=chunk-7Y5GHKZJ.mjs.map
