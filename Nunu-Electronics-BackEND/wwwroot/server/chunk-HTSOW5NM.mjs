...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomepageComponent, { className: "HomepageComponent", filePath: "src\\components\\homepage\\homepage.component.ts", lineNumber: 12 });
})();
...
function ProduseComponent_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const product_r1 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate("alt", product_r1.productName);
...
//# sourceMappingURL=chunk-HTSOW5NM.mjs.map
