...
var ContactPageComponent = class ContactPageComponent2 {
  ...
  onSubmit() {
    ...
    const textContentUser = `Salut ${fname}, ne-ai contactat despre ${problem}. Vom reveni cur\xE2nd.`;
...
//# sourceMappingURL=chunk-VTNVEWOG.mjs.map
